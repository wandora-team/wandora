...
and publishing application based on [Topic Maps](https://en.wikipedia.org/wiki/Topic_map) 
and [Java](https://en.wikipedia.org/wiki/Java_%28programming_language%29). Wandora suits well for 
...
Wandora's license is [GNU GPL](https://www.gnu.org/licenses/gpl-3.0.txt).

## Developer Introduction

To compile and run Wandora, a Java JDK 21 or later is required.

Wandora uses Gradle for dependency management and building application packages.

We use Eclipse, preferably Eclipse IDE for Java Developers version 2026-06 (4.40.0).
