 ...
 * a JScrollPane.
 * 
 * Simple usage: JTextPane textPane = new JTextPane(); JScrollPane scrollPane =
 * new JScrollPane(textPane); TextLineNumber tln = new TextLineNumber(textPane);
...
public class TextLineNumber extends JPanel implements CaretListener, DocumentListener, PropertyChangeListener {
    ...
    private int getOffsetY(int rowStartOffset, FontMetrics fontMetrics)
        ...
        int y = (int) Math.round(r.getY() + r.getHeight());
        int descent = 0;
        ...
        SwingUtilities.invokeLater(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    if (rect != null && ((int) Math.round(rect.getY())) != lastHeight) {
                        setPreferredWidth();
                        repaint();
                        lastHeight = (int) Math.round(rect.getY());
                    }
                }
