...
/**
 * This class represents the current state of the selection of the
 * AnySelectionTable. It keeps the information in a list of ListSelectionModels,
 * where each Model represents the selection of a column.
 * 
...
public class TableSelectionModel implements PropertyChangeListener, ListSelectionListener, TableModelListener {
    ...
    /**
     * Forwards the request to the ListSelectionModel at the specified column.
     */
    ...
    public void setLeadSelectionIndex(int row, int column) {
        ...
        if (lsm.isSelectionEmpty())
            ...
            // calling that method throws an IndexOutOfBoundsException when selection is
            // empty (?, JDK 1.1.8, Swing 1.1)
    ...
    /**
     * When the TableModel changes, the TableSelectionModel has to adapt to the new
     * Model. This method is called if a new TableModel is set to the JTable.
     */
    ...
    /**
     * Is called when the TableModel changes. If the number of columns had changed
     * this class will adapt to it.
     */
    ...
    public void tableChanged(TableModelEvent e) {
        ...
        // works, because you can't insert columns into a TableModel (only
        // add/romove(?)):
     ...
     * 
     * @see #fireValueChanged(Object source, int firstIndex, int lastIndex, int
     *      columnIndex, boolean isAdjusting)
     */
     ...
     */
    protected void fireValueChanged(Object source, int firstIndex, int lastIndex, int columnIndex,
            boolean isAdjusting) {
