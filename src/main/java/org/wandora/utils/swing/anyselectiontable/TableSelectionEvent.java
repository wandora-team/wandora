...
public class TableSelectionEvent extends ListSelectionEvent {
    ...
    public TableSelectionEvent(Object source, int firstRowIndex, int lastRowIndex, int columnIndex,
            boolean isAdjusting) {
     ...
     * 
     * @return The last column whose selection value has changed, where zero is the
     *         first column.
     */
