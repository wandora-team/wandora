...
public class GenericVelocityHelper {
    ...
    public static List<Topic> getAllPlayers(Topic topic) throws TopicMapException {
        List<Topic> players = new ArrayList<>();
        if (topic != null) {
            Collection<Association> associations = topic.getAssociations();
            for (Association a : associations) {
                try {
                    ...
                    for (Topic role : roles) {
                        if (!a.getPlayer(role).mergesWithTopic(topic))
                            players.add(a.getPlayer(role));
                    }
                }
                catch (Exception e) {
    ...
    public static List<Topic> getPlayers(Topic topic, String associationTypeSI, String roleSI)
    ...
    public static List<Topic> getPlayers(Topic topic, Topic type, Topic role) throws TopicMapException {
        List<Topic> players = new ArrayList<>();
    ...
    public static List<Topic> getPlayers(Topic topic, String associationTypeSI, String roleSI, String hasRole,
            String hasPlayer) throws TopicMapException {
        List<Topic> players = new ArrayList<>();
    ...
    public static List<Topic> getPlayers(Collection<Topic> topics, String associationTypeSI, String roleSI,
            String hasRole, String hasPlayer) {
        List<Topic> players = new ArrayList<>();
    ...
    public static List<Topic> getSortedPlayers(Topic topic, String associationTypeSI, String roleSI, String sortRole,
            String lang) throws TopicMapException {
        List<Topic[]> players = new ArrayList<>();
    ...
    public static List<Topic> getSortedPlayers(Topic topic, Collection<String> associationTypesSI,
            Collection<String> rolesSI, String sortRole, String lang) throws TopicMapException {
        List<Topic[]> players = new ArrayList<>();
        List<Topic> sortedPlayers = new ArrayList<>();
    ...
    public static List<Topic> getTypesOfRequiredType(Topic topic, String requiredTypeSI) {
        List<Topic> selectedTypes = new ArrayList<>();
    ...
    public static List<String> getSLsOfPlayers(Topic topic, String associationTypeSI, String roleSI)
            throws TopicMapException {
        List<Topic> players = getPlayers(topic, associationTypeSI, roleSI);
    ...
    public static <K> List<K> crop(Collection<K> collection, int start, int end) {
        List<K> cropped = new ArrayList<>();
        if (collection != null) {
    ...
    public static <K> List<K> cropPage(Collection<K> collection, int page, int pageSize) {
        List<K> cropped = new ArrayList<>();
        if (collection != null) {
    ...
    public static <K> List<K> makeIntersection(Collection<? extends K> a, Collection<? extends K> b) {
        List<K> intersection = new ArrayList<>();
    ...
    public static <K> Collection<K> removeDuplicates(Collection<K> objects) {
        Set<K> newCollection = new LinkedHashSet<K>();
    ...
    public static List<Topic> collectTopicsOfType(TopicMap topicmap, Topic typeTopic, int depth) {
        Set<Topic> results = new LinkedHashSet<>();
    ...
    public static List<Topic> collectPlayers(TopicMap topicmap, Topic topic, String associationTypeSI, String roleSI,
            String hasRole, String hasPlayer, int depth) {
        Set<Topic> results = new LinkedHashSet<>();
    ...
    public static <K> Vector<K> extractRandomVector(Collection<K> c, int newSize) {
        ...
        for (int i = 0; i < newSize; i++) {
            ...
            while (iter.hasNext() && randomStep-- > 0)
                iter.next();
            if (iter.hasNext())
                cropped.add(iter.next());
        }
        return cropped;
    }
    ...
    public static List<Topic> getRoles(Topic topic, String associationTypeSI) throws TopicMapException {
        List<Topic> roleList = new ArrayList<>();
        if (topic != null && associationTypeSI != null) {
            Topic type = topic.getTopicMap().getTopic(associationTypeSI);
            if (type != null) {
                Collection<Association> associations = topic.getAssociations(type);
    ...
    public static List<Association> getVisibleAssociations(Topic topic) throws TopicMapException {
        List<Association> associationVector = new ArrayList<>();
        if (topic != null) {
            Collection<Association> associations = topic.getAssociations();
            for (Association a : associations) {
                if (TMBox.associationVisible(a))
                    associationVector.add(a);
            }
        }
    ...
    public static Collection<Association> removeAssociationsByType(Collection<Association> v, Topic type)
            throws TopicMapException {
    ...
    public static Collection<Association> cropAssociationsByType(Topic topic, Collection<Association> v,
            String associationTypeSI) throws TopicMapException {
        if (associationTypeSI == null)
    ...
    public static Collection<Association> cropAssociationsByType(Collection<Association> v, Topic type)
            throws TopicMapException {
        List<Association> ret = new ArrayList<>();
        if (v != null && type != null) {
            for (Association a : v) {
    ...
    public static Collection<Topic> cropTopicsByVisibility(Collection<Topic> v) throws TopicMapException {
        ...
        if (v != null && v.size() > 0) {
            for (Topic t : v) {
                if (t != null && TMBox.topicVisible(t))
                    ret.add(t);
            }
        }
        return ret;
    ...
    public static List<Association> cropAssociationsByVisibility(Collection<Association> v) {
        List<Association> ret = new ArrayList<>();
        if (v != null) {
            for (Association a : v) {
                try {
                    if (a != null && TMBox.associationVisible(a))
                        ret.add(a);
                }
                catch (Exception e) {
                    logger.error(e);
    ...
    public static Collection<Topic> cropTopicsByClass(Collection<Topic> v, Topic typeTopic) throws TopicMapException {
        ...
        if (v != null && v.size() > 0 && typeTopic != null) {
            for (Topic t : v) {
                if (t != null && t.isOfType(typeTopic))
                    ret.add(t);
            }
        }
        return ret;
    ...
    public static Collection<Topic> cropTopicsIfHasAssociations(Collection<Topic> v, Topic associationTypeTopic)
            throws TopicMapException {
        List<Topic> ret = new ArrayList<>();
    ...
    public static Collection<Topic> cropTopicsIfHasPlayer(Collection<Topic> v, Topic associationTypeTopic, Topic role,
            Topic player) throws TopicMapException {
        List<Topic> ret = new ArrayList<>();
        Topic aplayer = null;
        Collection<Association> typedAssociations = null;
    ...
    public static Collection<Topic> cropTopicsIfHasPlayerRegex(Collection<Topic> v, Topic associationTypeTopic,
            Topic role, String playerRegex) throws TopicMapException {
    ...
    public static Collection<Topic> cropTopicsIfHasPlayerRegex(Collection<Topic> v, Topic associationTypeTopic,
            Topic role, String playerRegex, boolean find) throws TopicMapException {
        List<Topic> ret = new ArrayList<>();
        Topic aplayer = null;
    ...
    public static Collection<Topic> cropTopicsIfHasAssociationWithInPlayer(Collection<Topic> v,
            Topic associationTypeTopic, Topic role, Topic associationTypeTopic2) throws TopicMapException {
        List<Topic> ret = new ArrayList<>();
        Topic player = null;
        Collection<Association> typedAssociations = null;
        Collection<Association> typedAssociations2 = null;
        if (v != null && v.size() > 0 && associationTypeTopic != null && role != null
                && associationTypeTopic2 != null) {
            for (Topic t : v) {
                if (t != null) {
                    typedAssociations = t.getAssociations(associationTypeTopic);
                    if (typedAssociations != null && typedAssociations.size() > 0) {
    ...
    public static Collection<Topic> cropTopicsIfHasPlayerWithInPlayer(Collection<Topic> v, Topic associationTypeTopic,
            Topic role, Topic associationTypeTopic2, Topic role2, Topic player2) throws TopicMapException {
        List<Topic> ret = new ArrayList<>();
        Topic player = null;
    ...
    public static Collection<Topic> cropTopicsByRegex(Collection<Topic> v, String lang, String regex,
            boolean strictMatch) throws TopicMapException {
        return cropTopicsByRegex(v, lang, regex, strictMatch, false);
    }


    public static Collection<Topic> cropTopicsByRegex(Collection<Topic> v, String lang, String regex,
            boolean strictMatch, boolean caseSensitive) throws TopicMapException {
        List<Topic> ret = new ArrayList<>();
            ...
            for (Topic t : v) {
                try {
                    if (t != null) {
                        ...
                        if (topicName == null)
                            topicName = t.getOneSubjectIdentifier().toExternalForm();
    ...
    public static Collection<Topic> basenamePrefixSearch(TopicMap topicmap, String lang, String prefix,
            Topic typeTopic) {
        try {
            if (typeTopic != null && topicmap != null && lang != null && prefix != null) {
                ...
                for (Iterator<Topic> iter = topics.iterator(); iter.hasNext();) {
                    t = iter.next();
                    bn = t.getBaseName();
                    if (bn != null && bn.startsWith(prefix))
                        searchResults.add(t);
                }
...
//                    try { substring = encodeHTML(substring); } catch (Exception e) {}
    ...
    public static List<String> capitalizeFirst(List<String> words) {
        ...
        if (word != null) {
            for (int i = 0; i < word.length() && shouldCapitalize; i++) {
                if (Character.isLetter(word.charAt(i)) && shouldCapitalize) {
                    try {
                        word = word.substring(0, i) + (Character.toUpperCase(word.charAt(i)))
    ...
    public static boolean urlExists(String urlString) {
        if (urlString != null) {
            try {
                if (IObox.urlExists(new URI(urlString).toURL()))
                    return true;
            }
            catch (Exception e) {
            }
    ...
    public static Collection<Association> sortAssociationsWithPlayer(Collection<Association> associations,
            Topic sortRole, String lang) {
    ...
    public static Collection<Topic> sortTopicsWithOccurrence(Collection<Topic> topics, Topic occurrenceType,
            String lang) {
    ...
    public static Collection<Topic> sortTopicsWithOccurrence(Collection<Topic> topics, Topic occurrenceType,
        ...
        if (occurrenceType != null && lang != null) {
            try {
                return TMBox.sortTopicsByData(topics, occurrenceType, lang,
                        (desc.equalsIgnoreCase("true") ? true : false));
            }
            catch (Exception e) {
                // Ignore
            }
    ...
    public static Collection<Topic> sortTopicsWithPlayer(Collection<Topic> topics, Topic associationType, Topic role,
            String lang) {
        ...
        if (topics != null && topics.size() > 0) {
            for (Iterator<Topic> iter = topics.iterator(); iter.hasNext();) {
                try {
                    ...
                    if (extraSettings != null && extraSettings.indexOf("SWAP_ORDER") != -1)
    ...
    public static String changeStringEncoding(String s, String sourceenc, String targetenc) {
        if (s != null && targetenc != null && sourceenc != null) {
            try {
                return new String(s.getBytes(sourceenc), targetenc);
            }
            catch (Exception e) {
                logger.error(e);
            }
