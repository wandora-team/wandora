...
public class PresetContext<T> implements Context<T> {
     ...
     * modify or otherwise access. Generally returned iterator contains Topic(s)
     * found in the GUI element that originated tool's action event.
     *
    ...
    /**
     * Sets the origin of context. Normally context origin is a GUI element that
     * triggered the tool execution.
     */
    @Override
    ...
    /**
     * Returns the origin of context. Normally context origin is a GUI element that
     * triggered the tool execution. <code>PreContext
     * </pre>
     * has no context source as the context is set during construction.
     */
    @Override
