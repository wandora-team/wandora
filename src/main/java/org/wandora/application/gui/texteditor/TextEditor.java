...
public class TextEditor extends javax.swing.JDialog implements ActionListener {
    ...
    public JMenu getFileMenu() {
        ...
        Object[] menuStructure = new Object[] {
            "Open...", KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_O, java.awt.event.InputEvent.CTRL_DOWN_MASK), UIBox.getIcon("gui/icons/file_open.png"),
            "Save...", KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_S, java.awt.event.InputEvent.CTRL_DOWN_MASK), UIBox.getIcon("gui/icons/file_save.png"),
            "---",
            "Print...", KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_P, java.awt.event.InputEvent.CTRL_DOWN_MASK), UIBox.getIcon("gui/icons/print.png"),
            "---",
            "Close", KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_W, java.awt.event.InputEvent.CTRL_DOWN_MASK), UIBox.getIcon("gui/icons/exit.png"), 
        };
        fileMenu.removeAll();
    ...
    public JMenu getEditMenu() {
        ...
        Object[] menuStructure = new Object[] {
            "Undo", KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_Z, java.awt.event.InputEvent.CTRL_DOWN_MASK), UIBox.getIcon("gui/icons/undo_undo.png"),
            "Redo", KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_Y, java.awt.event.InputEvent.CTRL_DOWN_MASK), UIBox.getIcon("gui/icons/undo_redo.png"),
            "---",
            "Cut",  KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_X, java.awt.event.InputEvent.CTRL_DOWN_MASK), UIBox.getIcon("gui/icons/cut.png"),
            "Copy",  KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_C, java.awt.event.InputEvent.CTRL_DOWN_MASK), UIBox.getIcon("gui/icons/copy.png"),
            "Paste",  KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_V, java.awt.event.InputEvent.CTRL_DOWN_MASK), UIBox.getIcon("gui/icons/paste.png"),
            "Clear", UIBox.getIcon("gui/icons/clear.png"),
            "Trim", KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_T, java.awt.event.InputEvent.CTRL_DOWN_MASK), UIBox.getIcon("gui/icons/trim.png"),
            "---",
            "Select all", KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_A, java.awt.event.InputEvent.CTRL_DOWN_MASK), UIBox.getIcon("gui/icons/select_all.png"),
            "---",
            "Find...", KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_F, java.awt.event.InputEvent.CTRL_DOWN_MASK), UIBox.getIcon("gui/icons/find_generic.png"),
            "Replace...", KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_R, java.awt.event.InputEvent.CTRL_DOWN_MASK), UIBox.getIcon("gui/icons/replace.png"),
            "---",
    ...
    public void updateFormatMenu() {
        Object[] menuStructure = new Object[] {
            (shouldWrapLines ? "X " : "") + "Wrap lines", KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_L, java.awt.event.InputEvent.CTRL_DOWN_MASK), 
            "---",
            "Font", new Object[] {
        ...
        try {
            ...
            if("Trim".equalsIgnoreCase(c)) {
                ...
                try {
                	...
                	Object json = mapper.readValue(changeThis, Object.class);
                	prettyOutput = mapper.writerWithDefaultPrettyPrinter().writeValueAsString(json);
                    simpleTextPane.setText(prettyOutput);
                } catch (Exception objEx) { // Not a JSON Object
