...
public class ApuRahatCSVExtract extends AbstractExtractor implements WandoraTool {
    ...
    public Topic getHenkiloType( TopicMap tm ) throws Exception {
        return ExtractHelper.getOrCreateTopic(HENKILO_SI, "Henkil�", getApuRahatType(tm), tm);
    }
    ...
    public Topic getPaatosType( TopicMap tm ) throws Exception {
        return ExtractHelper.getOrCreateTopic(PAATOS_SI, "P��t�s", getApuRahatType(tm), tm);
    }
    public Topic getJasenType( TopicMap tm ) throws Exception {
        return ExtractHelper.getOrCreateTopic(JASEN_SI, "J�sen", getApuRahatType(tm), tm);
    }
    ...
    public Topic getLaaniType( TopicMap tm ) throws Exception {
        return ExtractHelper.getOrCreateTopic(LAANI_SI, "L��ni", getApuRahatType(tm), tm);
    }
    ...
    public Topic getSynnyinPaivaType( TopicMap tm ) throws Exception {
        return ExtractHelper.getOrCreateTopic(SYNNYINPAIVA_SI, "Synnyinp�iv�", getApuRahatType(tm), tm);
    }
