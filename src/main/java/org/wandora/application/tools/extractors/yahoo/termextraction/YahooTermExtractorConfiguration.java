...
public class YahooTermExtractorConfiguration extends javax.swing.JDialog {
    ...
    public YahooTermExtractorConfiguration(JFrame parent, Options options, AbstractYahooTermExtractor parentTool) {
        super(parent, true);
        this.parent = parent;
    ...
    private void initComponents() {
        ...
        clearAuthButton.setText("Forget Yahoo! Term Extractor APPID");
