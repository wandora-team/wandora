...
public class LayeredTopicMapType implements TopicMapType {
    ...
    @Override
    public TopicMap unpackageTopicMap(TopicMap topicmap, PackageInput in, String path, TopicMapLogger logger,
        ...
        while (true) {
            ...
            try {
                ...
                if ("true".equalsIgnoreCase(layerVisibility))
                    l.setVisible(true);
                else
                    l.setVisible(false);
                if ("true".equalsIgnoreCase(layerReadonly))
                    l.setReadOnly(true);
                else
                    l.setReadOnly(false);
