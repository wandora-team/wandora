...
public class XTMAdaptiveParser implements ContentHandler, ErrorHandler {
    ...
    public void characters(char[] ch, int start, int length) throws SAXException {
        if (selectedContentHandler != null)
            selectedContentHandler.characters(ch, start, length);
    }
    ...
    public void endDocument() throws SAXException {
        if (selectedContentHandler != null)
            selectedContentHandler.endDocument();
    }
    ...
    public void endElement(String uri, String localName, String qName) throws SAXException {
        if (selectedContentHandler != null)
            selectedContentHandler.endElement(uri, localName, qName);
    }
    ...
    public void endPrefixMapping(String prefix) throws SAXException {
        if (selectedContentHandler != null)
            selectedContentHandler.endPrefixMapping(prefix);
    }
    ...
    public void ignorableWhitespace(char[] ch, int start, int length) throws SAXException {
        if (selectedContentHandler != null)
            selectedContentHandler.ignorableWhitespace(ch, start, length);
    }
    ...
    public void processingInstruction(String target, String data) throws SAXException {
        if (selectedContentHandler != null)
            selectedContentHandler.processingInstruction(target, data);
    }
    ...
    public void setDocumentLocator(org.xml.sax.Locator locator) {
        if (selectedContentHandler != null)
            selectedContentHandler.setDocumentLocator(locator);
    }
    ...
    public void skippedEntity(String name) throws SAXException {
        if (selectedContentHandler != null)
            selectedContentHandler.skippedEntity(name);
    }
    ...
    public void startDocument() throws SAXException {
        if (selectedContentHandler != null)
            selectedContentHandler.startDocument();
    }
    ...
    public void startElement(String uri, String localName, String qName, Attributes atts) throws SAXException {
        ...
        if (selectedContentHandler != null)
            selectedContentHandler.startElement(uri, localName, qName, atts);
    }
    ...
    public void startPrefixMapping(String prefix, String uri) throws SAXException {
        ...
        if (selectedContentHandler != null)
            selectedContentHandler.startPrefixMapping(prefix, uri);
    }
    ...
    public void error(SAXParseException exception) throws SAXException {
        if (selectedErrorHandler != null)
            selectedErrorHandler.error(exception);
    }
    ...
    public void fatalError(SAXParseException exception) throws SAXException {
        if (selectedErrorHandler != null)
            selectedErrorHandler.fatalError(exception);
    }
    ...
    public void warning(SAXParseException exception) throws SAXException {
        if (selectedErrorHandler != null)
            selectedErrorHandler.warning(exception);
    }
