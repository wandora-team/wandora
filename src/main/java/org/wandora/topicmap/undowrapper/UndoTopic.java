...
public class UndoTopic extends Topic {
    ...
    public void addSubjectIdentifier(Locator l) throws TopicMapException {
        if (wrapped.getSubjectIdentifiers().isEmpty()) {
            ...
            try {
                ...
                topicMap.handleUndoException(ue);
            }
        }
        else {
            try {
    ...
    public void setBaseName(String name) throws TopicMapException {
        try {
            if (undoCreated())
                topicMap.addUndoOperation(new SetBaseNameOperation(wrapped, name));
        }
        catch (UndoException ue) {
            topicMap.handleUndoException(ue);
        }
    ...
    public void addType(Topic t) throws TopicMapException {
        ...
        try {
            if (undoCreated())
                topicMap.addUndoOperation(new AddTypeOperation(wrapped, wtype));
        }
        catch (UndoException ue) {
            topicMap.handleUndoException(ue);
        }
    ...
    public void removeType(Topic t) throws TopicMapException {
        ...
        try {
            if (undoCreated())
                topicMap.addUndoOperation(new RemoveTypeOperation(wrapped, wtype));
        }
        catch (UndoException ue) {
            topicMap.handleUndoException(ue);
        }
    ...
    public void setVariant(Set<Topic> scope, String name) throws TopicMapException {
        ...
        try {
            if (undoCreated())
                topicMap.addUndoOperation(new SetVariantOperation(wrapped, wscope, name));
        }
        catch (UndoException ue) {
            topicMap.handleUndoException(ue);
        }
    ...
    public void removeVariant(Set<Topic> scope) throws TopicMapException {
        ...
        try {
            if (undoCreated())
                topicMap.addUndoOperation(new SetVariantOperation(wrapped, wscope, null));
        }
        catch (UndoException ue) {
            topicMap.handleUndoException(ue);
        }
    ...
    public void setData(Topic type, Hashtable<Topic, String> versionData) throws TopicMapException {
        ...
        for (Map.Entry<Topic, String> e : versionData.entrySet()) {
            ...
            try {
                if (undoCreated())
                    topicMap.addUndoOperation(new SetOccurrenceOperation(wrapped, wtype, wversion, value));
            }
            catch (UndoException ue) {
                topicMap.handleUndoException(ue);
            }
    ...
    public void removeData(Topic type, Topic version) throws TopicMapException {
        ...
        try {
            if (undoCreated())
                topicMap.addUndoOperation(new SetOccurrenceOperation(wrapped, wtype, wversion, null));
        }
        catch (UndoException ue) {
            topicMap.handleUndoException(ue);
        }
    ...
    public void setSubjectLocator(Locator l) throws TopicMapException {
        try {
            if (undoCreated())
                topicMap.addUndoOperation(new SetSubjectLocatorOperation(wrapped, l));
        }
        catch (UndoException ue) {
            topicMap.handleUndoException(ue);
        }
    ...
    public Collection<Association> getAssociations(Topic type, Topic role) throws TopicMapException {
        return topicMap.wrapAssociations(
                wrapped.getAssociations(((UndoTopic) type).getWrapped(), ((UndoTopic) role).getWrapped()));
    }
