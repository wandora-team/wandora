...
Timeline._Impl.prototype._initialize = function() {
    ...
    zoomBox.innerHTML = '<input type="image" class="zoomButton" src="zoom_in.png" onclick="tl.zoomClicked(true)"/>'
    zoomBox.innerHTML += '<input type="image" class="zoomButton" src="zoom_out.png" onclick="tl.zoomClicked(false)"/>'
    containerDiv.appendChild(zoomBox);
...
Timeline._Impl.prototype.zoom = function (zoomIn, clientX, clientY, target) {
  ...
  this._bands[0].zoom(zoomIn, clientX, clientY);
  this._bands[1].zoom(zoomIn, clientX, clientY);
  this.paint();
  this.layout();
};

Timeline._Impl.prototype.zoomClicked = function(zoomIn) {
    var x = window.innerWidth/2;
    var y = window.innerHeight/2;
    this._bands[0].zoom(zoomIn, x, y);
    this._bands[1].zoom(zoomIn, x, y);
    this.paint();
    this.layout();
}