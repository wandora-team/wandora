...
public class MobyThesaurusExtractor extends AbstractExtractor implements WandoraTool {
    ...
    public String getGUIText(int textType) {
        switch(textType) {
            ...
            case DONE_FAILED: return "Done! No extractions! %1 Moby thesaurus data file(s) crawled!";
            case DONE_ONE: return "Done! Successful extraction! %1 Moby thesaurus data file(s) crawled!";
            case DONE_MANY: return "Done! Total %0 successful extractions! %1 Moby thesaurus data file(s) crawled!";
