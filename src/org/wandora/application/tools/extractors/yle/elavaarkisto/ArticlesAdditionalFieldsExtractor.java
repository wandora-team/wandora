...
7-884577,arkivet,"Fredrik Hackman, Ywe Jalander, �ivind Nyquist, Jyrki Rapp",RTV,61796,5720
20-87062,elava-arkisto,,,82350,
20-108693,elava-arkisto,"Leike 1: Hannu Vilpponen (tuot toim), Tauno Jarva (ohj), Risto Heikkil� (toimsiht), Leo Lehdist� & Seppo Heikki Salonen & Arne Wessberg & Erkki Saksa (toim), Pirjo Isom�ki (kuvsiht). Leike 2: Jarmo Porola (tuot ohj toim), Matti Rosvall (toim), Eija Pietarinen (kuvsiht). Leike 3: Kirsti Wallasvaara (juont).","TV2 Ajankohtaistoimitus. TV2 Viihdetoimitus.",48220,9230
20-94053,elava-arkisto,"LEENA VIHTONEN (TUOT), ANNELI SJ�STEDT (KUVSIHT). Matti Rosvall & Jouko Konttinen & Jarmo Porola (toim). Ulla Paulaniemi (kuvsiht). Mikko Alatalo (juont).","RTV Viihdetoimitus. TV2 Viihdetoimitus.",25733,4508
...
where:
    ...
    CONTRIBUTORS = artikkelin medioiden tekij�t
