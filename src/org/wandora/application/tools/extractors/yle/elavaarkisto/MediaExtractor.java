...
26-103988,TVClip,"Hyv�� y�t� ja huomenta materiaalinauhat",,"Laulava ratikkakuski Aarne Tenkanen oli G�st� Sundqvistin luomus",,Leirint�alue,,"Kaide J�rvisen esitt�m� raitiovaununkuljettaja Aarne Tenkanen esiintyi useissa G�sta Sundqvistin radio-ohjelmissa ennen siirtymist��n levy-ja lavat�hdeksi.",,"aihe: fiktiiviset henkil�t; henkil�: Kai J�rvinen; aihe: huumorimusiikki; tapahtuma: 1998; aihe: laulajat; henkil�: Aarne Tenkanen; aihe: raitiovaununkuljettajat; ohjelmatyyppi: haastattelut",,,,"Kai 'Kaide' J�rvinen (Aarne Tenkanen)","Axa Sorjanen - ohjaaja, haastattelut; Raino Kuisma - kuvaus; Tuomas Palola - ��nitys; Lasse Wikman - tuottaja",video,,fi,2399000,,1998-11-09,,0,0,1,"Axa Sorjanen",2014-05-19T15:10:09+03:00,
26-66172,TVClip,,,,"Det finlandssvenska v�dret fr�n Kaisaniemiparken",,,"�idinkieli.","Kurre �sterberg och meteorolog Kenneth Holmlund, Yle bildband",,,,,,"Tuottaja: Torsten Bergman; K�sikirjoittaja: Anneli Sj�stedt; Ohjaaja: �ivind Nyquist; Kuvaussihteeri: Barbro R�nn�ri; K�sikirjoittaja: Mikaela Groop; K�sikirjoittaja: Ann-Kristin Schevelew; Musiikin suunnittelija: Kaj Wessman; Lukija (kertoja/speak): Ann-Kristin Schevelew; Kuvaussuunnittelija: Pentti Jurvanen; Lavastussuunnittelija: Julia Tallgren; J�rjest�j�: Juha Suomela; Naamioitsija: P Aiho; Naamioitsija: N Bang; Pukusuunnittelija: Maija Kalkas; Graafinen suunnittelija: Pirjo Puolakka; muut: Anneli Sj�stedt, Birgitta Ohralahti, Immo Puustinen, Byman, H�iki�, Tonteri, Stig Granstr�m",video,V�ri,sv,298000,6,1988-11-05,,0,0,1,"Ida Fellman",2011-05-27T13:54:23+03:00,
26-42871,RadioClip,,,"102 b. Murhemielin, kyynel�iden",,,,"Jukka Lintinen",,,,,,,,audio,,fi,290000,,,,0,0,1,"Elina Yli-Ojanper�",2011-08-17T15:32:46+03:00,
...
where:
    ...
    ORIGINALTITLE_FI/ORIGINALTITLE_SV = alkuper�isohjelman nimi suomeksi/ruotsiksi
    DESCRIPTION_FI/DESCRIPTION_SV = sis�lt�kuvaus suomeksi/ruotsiksi
    KEYWORDS = avainsanat
    CLASSIFICATION_ANALYTICS = tilastointiluokka
    CLASSIFICATION_MAIN_CLASS, CLASSIFICATION_SUB_CLASS = sis�ll�n p��luokka, aliluokka
    ACTORS = esiintyj�t
    CONTRIBUTORS = tekij�t
    FORMAT = mediaformaatti (video, audio)
    COLOR = v�ri (Muva, V�ri, ...)
    LANGUAGE = kulutuskieli (fi, sv)
    DURATION = median kesto millisekunneissa
    DURATIONPERCENTAGE = median keston osuus alkuper�isen ohjelman kestosta (0-100)
    FIRSTRUN = ensijulkaisup�iv� (tarkkuus vaihtelee vuosikymmenest� p�iv�n tarkkuuteen)
    PUBLICATIONS = esitetysajat Ylen kanavilla
    GEORESTRICTION = maarajattu (1=kyll�, 0=ei)
    DOWNLOAD = ladattavissa (1=kyll�, 0=ei)
    EMBED = upotettavissa (1=kyll�, 0=ei)
    EA_CREATOR = El�v��n arkistoon julkaissut henkil�
    EA_PUBLISHED = julkaisuaika El�v�ss� arkistossa
    EA_UPDATED = viimeisin muokkausaika El�v�ss� arkistossa
