...
public class OpenCalaisConfiguration extends javax.swing.JDialog {
    ...
    public OpenCalaisConfiguration(JFrame parent, Options options, OpenCalaisClassifier parentTool) {
        super(parent, true);
        this.parent = parent;
    ...
    private void initComponents() {
        ...
        setTitle("OpenCalais Configuration");
        getContentPane().setLayout(new java.awt.GridBagLayout());

        contentPanel.setLayout(new java.awt.GridBagLayout());

        clearAuthButton.setText("Forget OpenCalais APIKEY");
