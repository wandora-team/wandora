 ...
 * @author  olli
 */
public class TreeAssociationsPanel extends javax.swing.JPanel {
    
    private boolean cancelled=true;
    
    private TopicTree.TreeAssociation[] allAssociations;
    private ArrayList<JCheckBox> checkboxes;
    
    private Component parent;
    private Wandora admin;
    
    /** Creates new form TreeAssociationsPanel */
    public TreeAssociationsPanel(TopicTree.TreeAssociation[] allAssociations,Set<String> selected,String root,String name,Component parent,Wandora admin)  throws TopicMapException {
        this.admin=admin;
        rootButton = new GetTopicButton(admin);
        initComponents();
        this.parent=parent;
