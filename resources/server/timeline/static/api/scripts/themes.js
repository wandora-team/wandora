...
Timeline.ClassicTheme._Impl = function() {
    ...
    this.event = {
        track: {
                   height: 32, // px. You will need to change the track
                               //     height if you change the tape height.
                      gap:  0, // px. Gap between tracks
                   offset:  0, // px. top margin above tapes
          autoWidthMargin:  1.5
        ...
        tape: {
            height:         32 // px. For thicker tapes, remember to change track height too.
        },
        instant: {
            ...
            impreciseIconMargin: 0   // A tape and an icon are painted for imprecise instant
    ...
    //        impreciseColor:    "#58A0DC",
      ...
      //      lineColor:         "#58A0DC",
        ...
        bubble: {
            width:          300, // px
            height:         230, 
            maxHeight:      500, // px Maximum height of bubbles. 0 means no max height. 
